    ...
    return (
        <div id="history">
            <div className="description" data-aos="fade-up">
                ...
                <p>
                    Mari, con su risa contagiosa, conoció a Fran, de mirada profunda y tranquila, en un café un lluvioso martes. 
            ...
            <div className="they">
                <div className="person" data-aos="fade-right" data-aos-delay="200">
                    <h3>Mari</h3>
                    <p>
                        Mari es una persona llena de vida y alegría. Su pasión por la fotografía y su amor por los animales 
